...
setwd('C:/Users/Gebruiker/Pictures/usermodels/user-models-group-project-user-s-next-top-model/Hour') 
datHour <- list.files(path='C:/Users/Gebruiker/Pictures/usermodels/user-models-group-project-user-s-next-top-model/Hour') %>%
  lapply(read_csv) %>%
  bind_rows

setwd('C:/Users/Gebruiker/Pictures/usermodels/user-models-group-project-user-s-next-top-model/Twenty')
dat20 <- list.files(path='C:/Users/Gebruiker/Pictures/usermodels/user-models-group-project-user-s-next-top-model/Twenty') %>%
  lapply(read_csv) %>%
  bind_rows

setwd('C:/Users/Gebruiker/Pictures/usermodels/user-models-group-project-user-s-next-top-model/Fatigue')
datFat <- list.files(path='C:/Users/Gebruiker/Pictures/usermodels/user-models-group-project-user-s-next-top-model/Fatigue') %>% 
  lapply(read_csv) %>%
  bind_rows
...
mean(newDat[newDat$cond=="Grind",]$correct) 
mean(newDat[newDat$cond=="Pomodoro",]$correct) 
mean(newDat[newDat$cond=="User model",]$correct)
```
...
sd(correctDat[correctDat$cond=="Grind",]$rt, na.rm = TRUE) 
mean(correctDat[correctDat$cond=="Pomodoro",]$rt, na.rm = TRUE) 
sd(correctDat[correctDat$cond=="Pomodoro",]$rt, na.rm = TRUE) 
mean(correctDat[correctDat$cond=="User model",]$rt, na.rm = TRUE) 
sd(correctDat[correctDat$cond=="User model",]$rt, na.rm = TRUE)
